...
<div style="display: flex; flex-direction: column; align-items: center; gap: 20px;">
  <!-- First Image Section -->
  <div style="text-align: center;">
    <h3 style="margin: 10px 0;">Attention map for each word from prompt 1 for the image of a cat</h3>
    <img src="assests\img\image_text_word_by_word_layer_all_layers_aggregate_prompt_1_cat.png" alt="Image 1" style="width: 60%; border: 1px solid #ccc; border-radius: 8px;">
  </div>

  <!-- Second Image Section -->
  <div style="text-align: center;">
    <h3 style="margin: 10px 0;">Attention map for each word from prompt 1 for the image of a dog</h3>
    <img src="assests\img\image_text_word_by_word_layer_all_layers_aggregate_prompt_1_dog.png" alt="Image 2" style="width: 60%; border: 1px solid #ccc; border-radius: 8px;">
  </div>
</div>
...
<div style="display: flex; flex-direction: column; align-items: center; gap: 20px;">
  <!-- First Image Section -->
  <div style="text-align: center;">
    <h3 style="margin: 10px 0;">Attention map for each word from prompt 2 for the image of a cat</h3>
    <img src="assests\img\image_text_word_by_word_layer_all_layers_aggregate_prompt_2_cat.png" alt="Image 1" style="width: 60%; border: 1px solid #ccc; border-radius: 8px;">
  </div>

  <!-- Second Image Section -->
  <div style="text-align: center;">
    <h3 style="margin: 10px 0;">Attention map for each word from prompt 2 for the image of a dog</h3>
    <img src="assests\img\image_text_word_by_word_layer_all_layers_aggregate_prompt_2_dog.png" alt="Image 2" style="width: 60%; border: 1px solid #ccc; border-radius: 8px;">
  </div>
</div>
...
<div style="display: flex; flex-direction: column; align-items: center; gap: 20px;">
  <!-- First Image Section -->
  <div style="text-align: center;">
    <h3 style="margin: 10px 0;">Attention map for each word from prompt 3 for the image of a cat</h3>
    <img src="assests\img\image_text_word_by_word_layer_all_layers_aggregate_prompt_3_cat.png" alt="Image 1" style="width: 60%; border: 1px solid #ccc; border-radius: 8px;">
  </div>

  <!-- Second Image Section -->
  <div style="text-align: center;">
    <h3 style="margin: 10px 0;">Attention map for each word from prompt 3 for the image of a dog</h3>
    <img src="assests\img\image_text_word_by_word_layer_all_layers_aggregate_prompt_3_dog.png" alt="Image 2" style="width: 60%; border: 1px solid #ccc; border-radius: 8px;">
  </div>
</div>
...
<div style="display: flex; flex-direction: column; align-items: center; gap: 20px;">
  <!-- First Image Section -->
  <div style="text-align: center;">
    <h3 style="margin: 10px 0;">Attention map for each word from prompt 4 for the image of a cat</h3>
    <img src="assests\img\image_text_word_by_word_layer_all_layers_aggregate_prompt_4_cat.png" alt="Image 1" style="width: 60%; border: 1px solid #ccc; border-radius: 8px;">
  </div>

  <!-- Second Image Section -->
  <div style="text-align: center;">
    <h3 style="margin: 10px 0;">Attention map for each word from prompt 4 for the image of a dog</h3>
    <img src="assests\img\image_text_word_by_word_layer_all_layers_aggregate_prompt_4_dog.png" alt="Image 2" style="width: 60%; border: 1px solid #ccc; border-radius: 8px;">
  </div>
</div>
...
<div style="display: flex; flex-direction: column; align-items: center; gap: 20px;">
  <!-- First Image Section -->
  <div style="text-align: center;">
    <h3 style="margin: 10px 0;">Attention map for each word from prompt 5 for the image of a cat</h3>
    <img src="assests\img\image_text_word_by_word_layer_all_layers_aggregate_prompt_5_cat.png" alt="Image 1" style="width: 60%; border: 1px solid #ccc; border-radius: 8px;">
  </div>

  <!-- Second Image Section -->
  <div style="text-align: center;">
    <h3 style="margin: 10px 0;">Attention map for each word from prompt 4 for the image of a dog</h3>
    <img src="assests\img\image_text_word_by_word_layer_all_layers_aggregate_prompt_5_dog.png" alt="Image 2" style="width: 60%; border: 1px solid #ccc; border-radius: 8px;">
  </div>
</div>
...
<div style="display: flex; flex-direction: column; align-items: center; gap: 20px;">
  <!-- First Image Section -->
  <div style="text-align: center;">
    <h3 style="margin: 10px 0;">Attention map for each word from prompt 6 for the image of a cat</h3>
    <img src="assests\img\image_text_word_by_word_layer_all_layers_aggregate_prompt_6_cat.png" alt="Image 1" style="width: 60%; border: 1px solid #ccc; border-radius: 8px;">
  </div>

  <!-- Second Image Section -->
  <div style="text-align: center;">
    <h3 style="margin: 10px 0;">Attention map for each word from prompt 6 for the image of a dog</h3>
    <img src="assests\img\image_text_word_by_word_layer_all_layers_aggregate_prompt_6_dog.png" alt="Image 2" style="width: 60%; border: 1px solid #ccc; border-radius: 8px;">
  </div>
</div>
